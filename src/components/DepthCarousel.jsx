...
const DepthCarousel = ({
  ...
  return (
    <div
      ...
      aria-label="Queue preview carousel"
      tabIndex={0}
    ...
    >
          ...
          >
            ...
            {(item.name || item.artists) && (
              <div className="depth-carousel__card-meta">
                <div className="depth-carousel__card-badge">#{i + 1}</div>
      ...
      {showIndicators && count > 1 && (
        <div className="depth-carousel__dots" role="tablist" aria-label="Queue tracks">
          {data.map((_, i) => (
            <button
              key={i}
              type="button"
