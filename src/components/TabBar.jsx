 ...
 * "NOW PLAYING", "PLAYING NEXT", "RECENTLY PLAYED", and "LYRICS" views.
 *
 * @param {{
 *   activeTab: 'now-playing' | 'playing-next' | 'recently-played' | 'lyrics',
 *   onSelectTab: (tab: 'now-playing' | 'playing-next' | 'recently-played' | 'lyrics') => void
 * }} props
 */
